...
struct _Replace_copy_if : _Traits_ {
	template <class _InIterator_, class _Sentinel_, class _OutIterator_, class _Predicate_, class _Projection_, class _ValueType_>
	struct __impl {
		...
		constexpr explicit __impl(_InIterator_ __in_it, _Sentinel_ __in_sent, _OutIterator_ __out_it,
		...
		constexpr raze_always_inline std::ranges::unary_transform_result<_InIterator_, _OutIterator_> result() const noexcept {
	...
	struct __vectorized_replace_copy {
		template <class _InIterator_, class _Sentinel_, class _OutIterator_, class _Predicate_, class _Projection_, class _ValueType_>
		raze_always_inline std::ranges::unary_transform_result<_InIterator_, _OutIterator_> operator()(
			_InIterator_ __first, _Sentinel_ __last, _OutIterator_ __result,
		...
		template <sizetype _AlignedSize_, sizetype _TailSize_,
			class _InIterator_, class _Sentinel_, class _OutIterator_, class _Predicate_, class _Projection_, class _ValueType_>
		raze_always_inline std::ranges::unary_transform_result<_InIterator_, _OutIterator_> operator()(
	...
	constexpr raze_always_inline std::ranges::unary_transform_result<_InIterator_, _OutIterator_> operator()(
		_InIterator_ __first, _Sentinel_ __last, _OutIterator_ __result,
		_Predicate_ __pred, const _ValueType_& __new_value, _Projection_ __proj = {}) const noexcept
			requires(std::indirectly_copyable<_InIterator_, _OutIterator_> &&
				std::indirect_unary_predicate<_Predicate_, std::projected<_InIterator_, _Projection_>> &&
...
private:
	template <class _InIterator_, class _Sentinel_, class _OutIterator_, class _Predicate_, class _ValueType_, class _Projection_>
	constexpr raze_always_inline std::ranges::unary_transform_result<_InIterator_, _OutIterator_> __replace_copy_if_unchecked(
		_InIterator_ __first, _Sentinel_ __last, _OutIterator_ __result,
		_Predicate_ __pred, const _ValueType_& __new_value, _Projection_ __proj) const noexcept
	{
		...
		using _InValue_ = std::iter_value_t<_InIterator_>;

		if constexpr (std::contiguous_iterator<_InIterator_> && std::contiguous_iterator<_OutIterator_> &&
			vectorizable_unary_predicate<_Predicate_, _InIterator_> &&
			vectorizable_projection<_Projection_, _InIterator_>)
		{
			if not consteval {
				return vx::__dispatch_sized_impl<__vectorized_replace_copy, _InValue_,
					std::ranges::unary_transform_result<_InIterator_, _OutIterator_>>(
	...
	template <class _InIterator_, class _Sentinel_, class _OutIterator_, class _Predicate_, class _ValueType_, class _Projection_, sizetype _Size_>
	constexpr raze_always_inline std::ranges::unary_transform_result<_InIterator_, _OutIterator_> __replace_copy_if_unchecked(
		_InIterator_ __first, _Sentinel_ __last, _OutIterator_ __result,
...
struct _Replace_copy : _Traits_ {
				...
				std::indirectly_writable<_OutIterator_, const _ValueType2_&>)
	{
		return replace_copy_if(std::move(__first), std::move(__last), std::move(__result),
			algorithm::equal_to(function_return_type<_Projection_, std::iter_value_t<_InIterator_>>(__old_value)),
