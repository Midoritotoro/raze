...
struct _Ends_with : _Traits_ {
	...
	{
		return __ends_with_unchecked(traits::__uiter<_Sentinel1_>(std::move(__first1)),
	...
	{
		return __ends_with_unchecked(traits::__r_uiter<_Range1_>(std::ranges::begin(__range1)),
					...
					std::ranges::iterator_t<_Range2_>, _Predicate_, _Projection1_, _Projection2_>)
	{
		...
		else return __ends_with_unchecked(traits::__r_uiter<_Range1_>(std::ranges::begin(__range1)),
			traits::__uend(__range1), traits::__r_uiter<_Range2_>(std::ranges::begin(__range2)),
			traits::__uend(__range2), traits::__fwd_fn(__pred), traits::__fwd_fn(__proj1),
			traits::__fwd_fn(__proj2));
	}
