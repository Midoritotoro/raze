...
struct _Find : _Traits_ {
	...
	struct __impl {
		...
		raze_no_stack_protector raze_always_inline raze_nodiscard constexpr bool operator()(_Simd_) noexcept {
		...
		_Sentinel_ __last, const std::type_identity_t<_Value_>& __value, _Projection_ __proj = {}) const noexcept
	{
		...
		auto __work = __impl(__first_unwrapped, __last_unwrapped, __value, __proj);
