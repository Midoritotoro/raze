...
struct _Minmax_value : _Traits_ {
	...
	struct __vectorized_minmax_value {
		...
		raze_nodiscard raze_always_inline std::pair<std::iter_value_t<_Iterator_>, std::iter_value_t<_Iterator_>>
			operator()(_Iterator_ __first, _Sentinel_ __sentinel, Projection __proj) const noexcept requires(!vx::simd_type<_Tag_>)
		{
	...
	raze_nodiscard constexpr raze_always_inline std::optional<std::pair<std::iter_value_t<_Iterator_>, std::iter_value_t<_Iterator_>>>
		operator()(_Iterator_ __first, _Sentinel_ __last, Projection __proj = {}) const noexcept
	{
	...
	constexpr raze_always_inline std::optional<std::pair<std::ranges::range_value_t<Range>, std::ranges::range_value_t<Range>>>
...
private:
	template <class _Iterator_, class _Sentinel_, class Projection>
	raze_nodiscard constexpr raze_always_inline std::optional<std::pair<std::iter_value_t<_Iterator_>, std::iter_value_t<_Iterator_>>>
		__minmax_unchecked(_Iterator_ __first, _Sentinel_ __last, Projection __proj) const noexcept
	{
		...
		return std::optional<_Return_> { options::_unroller_t<_TraitsType, vx::scalar_tag>(__impl(__first, __last, __proj)) };
	}

	template <class _Iterator_, class _Sentinel_, class Projection, sizetype _Size_>
	raze_nodiscard constexpr raze_always_inline std::optional<std::pair<std::iter_value_t<_Iterator_>, std::iter_value_t<_Iterator_>>>
		__minmax_unchecked(_Iterator_ __first, _Sentinel_ __last, Projection __proj, std::integral_constant<sizetype, _Size_> __size) const noexcept
	{
		__verify_range(__first, __last);
