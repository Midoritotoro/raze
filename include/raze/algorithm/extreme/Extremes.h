...
struct _Extremes : _Traits_ {
	...
	struct __vectorized_extremes {
		...
		raze_nodiscard raze_always_inline std::pair<std::iter_value_t<_Iterator_>, std::iter_value_t<_Iterator_>> 
			...
			_Iterator_ __first, _Sentinel_ __sentinel, _Comp_ __comp, Projection __proj) 
	...
	constexpr raze_always_inline std::optional<std::pair<std::ranges::range_value_t<Range>, std::ranges::range_value_t<Range>>> operator()(
	...
	template <std::ranges::input_range Range, class _Comp_ = std::greater<>, class Projection = std::identity>
	constexpr raze_always_inline std::optional<std::pair<std::ranges::range_value_t<Range>, std::ranges::range_value_t<Range>>> operator()(Range&& __range,
...
private:
	...
	raze_nodiscard constexpr raze_always_inline std::optional<std::pair<std::iter_value_t<_Iterator_>, std::iter_value_t<_Iterator_>>>
		__extremes_unchecked(_Iterator_ __first, _Sentinel_ __last, _Comp_ __comp, Projection __proj) const noexcept
	{
		...
		return std::optional<_Return_> { options::_unroller_t<_TraitsType, vx::scalar_tag>(__impl(__first, __last, __comp, __proj)) };
	}

	template <class _Iterator_, class _Sentinel_, class _Comp_, class Projection, sizetype _Size_>
	raze_nodiscard constexpr raze_always_inline std::optional<std::pair<std::iter_value_t<_Iterator_>, std::iter_value_t<_Iterator_>>>
		__extremes_unchecked(_Iterator_ __first, _Sentinel_ __last, _Comp_ __comp, Projection __proj, 
