...
struct _Reverse_copy : _Traits_ {
	...
	{
		auto __r = __reverse_copy_unchecked(traits::__uiter<_Sentinel_>(std::move(__first)),
	...
	template <std::ranges::bidirectional_range Range, std::weakly_incrementable _OutIterator_>
