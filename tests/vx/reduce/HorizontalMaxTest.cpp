...
RTTS_CASE_TPL("raze::vx::horizontal_max", rtts::simd::all_simd_infos)
<class Simd> (rtts::type<Simd>) {
    ...
    {
        auto result = raze::vx::horizontal_max(v);
    ...
    for (size_t iteration = 0; iteration < 1000; ++iteration) {
        ...
        {
            auto result = raze::vx::horizontal_max[fbk, mask](v);
        ...
        {
            auto result = raze::vx::horizontal_max[mask](v);
