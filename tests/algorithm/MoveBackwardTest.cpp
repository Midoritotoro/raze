...
int main() {
    // Пустой диапазон
    {
        std::vector<int> src;
        std::vector<int> dst;
        auto out = raze::algorithm::move_backward(src.begin(), src.end(), dst.end());
    ...
    // Перекрытие: сдвиг вправо
    {
        ...
        // raze::algorithm::move_backward [0..4) → [2..6)
        raze::algorithm::move_backward(v.begin(), v.begin() + 4, v.begin() + 6);
    ...
    // Перекрытие: сдвиг влево
    {
        ...
        // raze::algorithm::move_backward [2..5) → [0..3)
        raze::algorithm::move_backward(v.begin() + 2, v.end(), v.begin() + 3);
...

    {
        ...
        std::cout << "Large raze::algorithm::move_backward of " << N << " ints took " << ms << " ms\n";
    }
