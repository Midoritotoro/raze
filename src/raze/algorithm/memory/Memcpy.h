...
raze_unmangled raze_no_stack_protector raze_declare_const_function void* raze_stdcall __raze_memcpy_avx(void* raze_restrict __dst,
	const void* raze_restrict __src, sizetype __aligned_bytes, sizetype __tail_bytes) noexcept
{
...
raze_unmangled raze_no_stack_protector raze_declare_const_function void* raze_stdcall __raze_memcpy_avx512f(void* raze_restrict __dst,
	const void* raze_restrict __src, sizetype __aligned_bytes, sizetype __tail_bytes) noexcept
{
...
struct __vectorized_memcpy {
	...
	{
		return __raze_memcpy_scalar(__dst, __src, __bytes);
	}
		...
		void* raze_restrict __dst, const void* raze_restrict __src, sizetype __bytes) const noexcept
	{
		...
		if constexpr (vx::__has_avx512f_support_v<_Abi_::isa>) return __raze_memcpy_avx512f(__dst, __src, __aligned_size, __tail_size);
		else if constexpr (vx::__has_avx_support_v<_Abi_::isa>) return __raze_memcpy_avx(__dst, __src, __aligned_size, __tail_size);
		else return __raze_memcpy_sse2(__dst, __src, __aligned_size, __tail_size);
	}
};

raze_unmangled raze_no_stack_protector raze_declare_const_function void* raze_stdcall __raze_memcpy(void* raze_restrict __dst,
	const void* raze_restrict __src, sizetype __bytes) noexcept
{
	return vx::__dispatch_sized_impl<__vectorized_memcpy, i32, void*>(__bytes, __dst, __src, __bytes);
}
...
struct _Memcpy : _Traits_ {
		...
		const void* raze_restrict __src, sizetype __bytes) const noexcept
	{
		...
		if constexpr (options::__get_forced_isa<_TraitsType_>() == arch::ISA::None) return __raze_memcpy(__dst, __src, __bytes);
		else return vx::__dispatch_sized_impl<__vectorized_memcpy, i32, void*, options::__get_forced_isa<_TraitsType_>()>(__bytes, __dst, __src, __bytes);
	}
	...
	{
		using _TraitsType_ = decltype(_Traits_::traits());
		return vx::__dispatch_sized_impl<__vectorized_memcpy, i32, void*, options::__get_forced_isa<_TraitsType_>()>(__bytes, __dst, __src, __bytes);
	}
};
