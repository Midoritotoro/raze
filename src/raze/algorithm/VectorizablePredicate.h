...
template <class _Predicate_, class _Iterator_>
concept vectorizable_unary_predicate = !always_scalar<_Predicate_, _Iterator_> && requires {
...
template <class _Predicate_, class _Iterator_>
concept vectorizable_binary_predicate = !always_scalar<_Predicate_, _Iterator_> && requires {
	{ std::invoke(std::declval<__function_unwrapped<std::remove_cvref_t<_Predicate_>>>(), std::declval<__simd_value_t<_Iterator_>>(),
