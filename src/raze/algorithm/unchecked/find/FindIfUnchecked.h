...
template <
	...
	class _Predicate_>
__simd_nodiscard_inline_constexpr _InputUnwrappedIterator_ __find_if_unchecked(
	_InputUnwrappedIterator_	__first_unwrapped,
	_InputUnwrappedIterator_	__last_unwrapped,
	_Predicate_					__predicate) noexcept(
		std::is_nothrow_invocable_v<_Predicate_, std::iter_value_t<_InputUnwrappedIterator_>>)
{
