...
__raze_simd_algorithm_inline bool __contains_subrange_scalar(
...
struct __contains_subrange_vectorized_internal {
    using _ValueType = typename _Simd_::value_type;

    raze_static_operator __raze_simd_algorithm_inline bool operator()(
        ...
        sizetype    __sub_length) raze_const_operator noexcept
    {
        ...
        return __contains_subrange_scalar<_ValueType>(__remaining_first,
...
template <class _Type_>
__raze_simd_algorithm_inline bool __contains_subrange_vectorized(
    const void* __main_first,
    sizetype	__main_length,
    const void* __sub_first,
    sizetype	__sub_length) noexcept
