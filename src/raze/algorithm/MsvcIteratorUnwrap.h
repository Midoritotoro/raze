...
raze_always_inline raze_nodiscard constexpr decltype(auto) __unwrap_iterator(_Iterator_&& __iterator)
...
template <class _Iterator_>
raze_always_inline raze_nodiscard constexpr decltype(auto) __unwrap_unverified_iterator(_Iterator_&& __iterator)
    noexcept(type_traits::__is_possibly_unverified_iterator_unwrappable_v<_Iterator_> == false)
{
    if constexpr (std::is_pointer_v<std::decay_t<_Iterator_>>) return __iterator + 0;
    else if constexpr (type_traits::__is_possibly_unverified_iterator_unwrappable_v<_Iterator_>) return std::move(__iterator)._Unwrapped();
    else return std::move(__iterator);
}
...
template <class _Iterator_, class _DifferenceType_>
raze_always_inline raze_nodiscard constexpr decltype(auto) __unwrap_iterator_offset(
    _Iterator_&& __iterator, _DifferenceType_ __offset) noexcept(
...
template <class _Iterator_, class _DifferenceType_>
raze_always_inline raze_nodiscard constexpr decltype(auto) __unwrap_iterator_bytes_offset(
    _Iterator_&& __iterator, _DifferenceType_ __offset_bytes) noexcept(
        type_traits::__is_possibly_unverified_iterator_unwrappable_v<_Iterator_> == false ||
        (type_traits::__is_iterator_unwrappable_for_offset_v<_Iterator_> == false ||
            type_traits::__is_iterator_unwrappable_for_offset_v<_Iterator_>))
{
    ...
    if constexpr (std::is_pointer_v<std::decay_t<_Iterator_>>) return __iterator + 0;
    else return __unwrap_iterator_offset(std::move(__iterator), (__offset_bytes / sizeof(_ValueType)));
}
