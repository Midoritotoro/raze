...
template <class _FirstType_, class _SecondType_>
...
struct __is_safe_find_with_object_pointers<_FirstType_*, _SecondType_*>:
    std::conjunction<
        std::disjunction<std::is_object<_FirstType_>, std::is_void<_FirstType_>>,
        std::disjunction<std::is_object<_SecondType_>, std::is_void<_SecondType_>>,
        std::disjunction<std::is_same<std::remove_cv_t<_FirstType_>, std::remove_cv_t<_SecondType_>>,
        std::is_void<_FirstType_>, std::is_void<_SecondType_>>>
{};

template <class _Type_, class _Element_>
constexpr bool __is_vectorized_algorithm_element_safe_v = std::disjunction_v<
    ...
    std::conjunction<std::is_floating_point<_Type_>, std::is_floating_point<_Element_>>,
...
template <class _Iterator_, class _Type_>
