...
constexpr raze_always_inline float __tan(float __x) noexcept {
    
}

constexpr raze_always_inline double __tan(double __x) noexcept {

}

template <class _Simd_>
raze_always_inline _Simd_ __tan(const _Simd_& __x) noexcept
