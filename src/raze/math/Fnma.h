...
raze_nodiscard raze_always_inline _Type_ __fnma(
...
raze_nodiscard raze_always_inline _Simd_ __fnma(
	const _Simd_& __x,
	const _Simd_& __y,
		...
		requires(vx::__is_valid_simd_v<_Simd_>)
{
	...
	return vx::_Fnma<_RawType::__isa, _RawType::__width, typename _RawType::value_type>()(
			...
			(vx::__is_where_v<_WhereExpression_> || vx::__is_where_zero_v<_WhereExpression_>))
{
	...
	if constexpr (vx::__is_where_v<_WhereExpression_>)
		return vx::_Blend<_RawSimdType::__isa, _RawSimdType::__width, typename _RawSimdType::value_type>()(
			vx::_Fnma<_RawSimdType::__isa, _RawSimdType::__width, typename _RawSimdType::value_type>()(
				vx::__data(__x), vx::__data(__y), vx::__data(__z.data())), vx::__data(__z.source()), vx::__data(__z.mask()));
	else
		return vx::_Maskz_fnma<_RawSimdType::__isa, _RawSimdType::__width, typename _RawSimdType::value_type>()(
