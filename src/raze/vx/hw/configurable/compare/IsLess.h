...
struct configurable_is_less_t: options::conditional_callable<configurable_is_less_t, Options> {
...
constexpr inline auto is_less = options::functor<configurable_is_less_t>;
