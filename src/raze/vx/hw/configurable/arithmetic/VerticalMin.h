...
struct _Configurable_vertical_min: raze::options::strict_elementwise_callable<_Configurable_vertical_min, _Options_> {
    ...
    static raze_always_inline auto deferred_call(auto __options, const _Simd_& __x, const _Simd_& __y) noexcept {
        ...
        auto __chunk_op = [&] <class _Chunk, class ... _Args> (_Chunk& __chunk, _Args&&... __args) raze_always_inline_lambda {
            __chunk = _Vertical_min<_Simd_::__isa, typename _Simd_::value_type>()(__chunk, std::forward<_Args>(__args)...);
        };
    ...
    using callable_tag_type = _Configurable_vertical_min;
};
