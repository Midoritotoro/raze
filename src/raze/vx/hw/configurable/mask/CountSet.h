...
struct _Configurable_count_set: raze::options::strict_elementwise_callable<_Configurable_count_set, _Options_> {
    ...
    using callable_tag_type = _Configurable_count_set;
};
