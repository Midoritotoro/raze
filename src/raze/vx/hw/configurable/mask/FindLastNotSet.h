...
struct _Configurable_find_last_not_set: raze::options::strict_elementwise_callable<_Configurable_find_last_not_set, _Options_> {
    ...
    static raze_always_inline auto deferred_call(auto __options, const _Type_& __x) noexcept {
        ...
        auto __chunk_op = [&] <class _Chunk, class ... _Args_> (const _Chunk& __chunk, _Args_&& ... __args) raze_always_inline_lambda {
            __index += _Find_last_not_set<_Abi_::isa, _Chunk::size, _Value_>()(__storage_unwrap(__chunk), __storage_unwrap<_Args_>(__args)...);
