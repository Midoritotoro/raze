...
struct _Ternarylogic {
    ...
    raze_nodiscard raze_static_operator raze_always_inline _Tp_ operator()(
        _Tp_ __x, _Tp_ __y,  _Tp_ __z, std::integral_constant<uint8, _TernaryMask_> __imm8) raze_const_operator noexcept
    {
        if constexpr (__has_avx512f_support_v<_ISA_>) {
            if constexpr (sizeof(_Tp_) == 64)  return __as<_Tp_>(_mm512_ternarylogic_epi32(__as<__m512i>(__x), __as<__m512i>(__y), __as<__m512i>(__z), __imm8));
             ...
             auto __and    = _And<_ISA_, _Type_>();
             auto __or     = _Or<_ISA_, _Type_>();
             auto __xor    = _Xor<_ISA_, _Type_>();
             auto __andnot = _Andnot<_ISA_, _Type_>();
             auto __not    = _Not<_ISA_, _Type_>();
             auto __zero   = _Zero<_ISA_, _Type_>();
    ...
    raze_nodiscard raze_always_inline _Tp_ operator()(_Tp_ __x, _Tp_ __y,  _Tp_ __z, 
        std::integral_constant<uint8, _TernaryMask_> __imm8,  _Mask_ __mask) const noexcept
    {
        if constexpr (__has_avx512f_support_v<_ISA_> && std::is_integral_v<_Mask_>) {
     ...
     template <
        ...
        uint8                       _TernaryMask_>
    raze_nodiscard raze_always_inline _Tp_ operator()(_Tp_ __x, _Tp_ __y,  _Tp_ __z, 
        std::integral_constant<uint8, _TernaryMask_> __imm8,  _Mask_ __mask, _Tp_ __src) const noexcept
    {
