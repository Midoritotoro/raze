...
struct _Mask_ternarylogic {
    ...
    {
        if constexpr (intrin_type<_Tp_>) return _Ternarylogic<_ISA_, _Type_>()(__x, __y, __z, __imm8);
        else return _Ternarylogic_emulated()(__x, __y, __z, __imm8, _Mask_or<_ISA_, _Type_>(), _Mask_xor<_ISA_, _Type_>(),
    ...
    {
        return _Mask_bit_selectz<_ISA_, _Type_>()(_Mask_ternarylogic()(__x, __y, __z, __imm8), __mask);
    }
    ...
    {
        return _Mask_bit_select<_ISA_, _Type_>()(_Mask_ternarylogic()(__x, __y, __z, __imm8), __src, __mask);
    }
};
