...
raze_nodiscard raze_always_inline auto __make_rotate_right_idx(_Intrin_, i32 __sh) noexcept {
...
raze_nodiscard raze_always_inline pattern_vector_t<_Pattern_> __rotate_right(const pattern_vector_t<_Pattern_>& __x, _Pattern_ __p) noexcept {
    ...
    if constexpr (__is_fallback<_Ret>) return __rotate_right_fallback(__x, __get_rotate_right_shift(__p));
