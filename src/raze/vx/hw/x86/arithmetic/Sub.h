...
struct _Sub<arch::ISA::SSE2, 128, _Type_> {
		...
		_IntrinType_ __right) const noexcept
	{
		if constexpr (__is_epi64_v<_Type_> || __is_epu64_v<_Type_>)
			return __as<_IntrinType_>(_mm_sub_epi64(__as<__m128i>(__left), __as<__m128i>(__right)));

		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>)
			return __as<_IntrinType_>(_mm_sub_epi32(__as<__m128i>(__left), __as<__m128i>(__right)));

		else if constexpr (__is_epi16_v<_Type_> || __is_epu16_v<_Type_>)
			return __as<_IntrinType_>(_mm_sub_epi16(__as<__m128i>(__left), __as<__m128i>(__right)));

		else if constexpr (__is_epi8_v<_Type_> || __is_epu8_v<_Type_>)
			return __as<_IntrinType_>(_mm_sub_epi8(__as<__m128i>(__left), __as<__m128i>(__right)));

		else if constexpr (__is_ps_v<_Type_>)
			return __as<_IntrinType_>(_mm_sub_ps(__as<__m128>(__left), __as<__m128>(__right)));

		else if constexpr (__is_pd_v<_Type_>)
			return __as<_IntrinType_>(_mm_sub_pd(__as<__m128d>(__left), __as<__m128d>(__right)));
	}
...
struct _Sub<arch::ISA::SSE41, 128, _Type_> {
	...
	raze_nodiscard raze_always_inline _IntrinType_ operator()(
		...
		_IntrinType_ __right) const noexcept
	{
		return _Sub<arch::ISA::SSE2, 128, _Type_>()(__left, __right);
	}
...
struct _Sub<arch::ISA::AVX512VLF, 128, _Type_> {
	...
	raze_nodiscard raze_always_inline _IntrinType_ operator()(
		...
		_IntrinType_ __right) const noexcept
	{
		return _Sub<arch::ISA::AVX2, 128, _Type_>()(__left, __right);
	}
			...
			requires(__is_intrin_type_v<_MaskType_> || std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_intrin_type_v<_MaskType_> || sizeof(_Type_) < 4) {
			...
			return __as<_IntrinType_>(_mm_mask_sub_epi64(__as<__m128i>(__source),
				__mask, __as<__m128i>(__left), __as<__m128i>(__right)));
		}
		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm_mask_sub_epi32(__as<__m128i>(__source),
				__mask, __as<__m128i>(__left), __as<__m128i>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm_mask_sub_ps(__as<__m128>(__source),
				__mask, __as<__m128>(__left), __as<__m128>(__right)));
		}
		else if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm_mask_sub_pd(__as<__m128d>(__source),
...
struct _Sub<arch::ISA::AVX512VLBW, 128, _Type_> {
	...
	raze_nodiscard raze_always_inline _IntrinType_ operator()(
		...
		_IntrinType_ __right) const noexcept
	{
		return _Sub<arch::ISA::AVX512VLF, 128, _Type_>()(__left, __right);
	}
			...
			requires(__is_intrin_type_v<_MaskType_> || std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_intrin_type_v<_MaskType_> || sizeof(_Type_) >= 4) {
			...
			return __as<_IntrinType_>(_mm_mask_sub_epi8(__as<__m128i>(__source),
				__mask, __as<__m128i>(__left), __as<__m128i>(__right)));
		}
	}
};
...
struct _Sub<arch::ISA::AVX, 256, _Type_> {
		...
		_IntrinType_ __right) const noexcept
	{
		if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_sub_ps(
				__as<__m256>(__left),
				__as<__m256>(__right)));
		}
		else if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_sub_pd(
				__as<__m256d>(__left),
				__as<__m256d>(__right)));
		}
		else {
			const auto __low = _Sub<arch::ISA::SSE42, 128, _Type_>()(
				__as<__m128i>(__left), __as<__m128i>(__right));
			const auto __high = _Sub<arch::ISA::SSE42, 128, _Type_>()(
...
struct _Sub<arch::ISA::AVX2, 256, _Type_> {
	...
	{
		if constexpr (__is_epi64_v<_Type_> || __is_epu64_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi64(__as<__m256i>(__left), __as<__m256i>(__right)));

		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi32(__as<__m256i>(__left), __as<__m256i>(__right)));

		else if constexpr (__is_epi16_v<_Type_> || __is_epu16_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi16(__as<__m256i>(__left), __as<__m256i>(__right)));

		else if constexpr (__is_epi8_v<_Type_> || __is_epu8_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi8(__as<__m256i>(__left), __as<__m256i>(__right)));

		else if constexpr (__is_ps_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_ps(__as<__m256>(__left), __as<__m256>(__right)));

		else if constexpr (__is_pd_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_pd(__as<__m256d>(__left), __as<__m256d>(__right)));
	}
...
struct _Sub<arch::ISA::AVX512VLF, 256, _Type_> {
	...
	raze_nodiscard raze_always_inline _IntrinType_ operator()(
		...
		_IntrinType_ __right) const noexcept
	{
		return _Sub<arch::ISA::AVX2, 256, _Type_>()(__left, __right);
	}
			...
			requires(__is_intrin_type_v<_MaskType_> || std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_intrin_type_v<_MaskType_> || sizeof(_Type_) < 4) {
			...
			return __as<_IntrinType_>(_mm256_mask_sub_epi64(__as<__m256i>(__source),
				__mask, __as<__m256i>(__left), __as<__m256i>(__right)));
		}
		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_mask_sub_epi32(__as<__m256i>(__source),
				__mask, __as<__m256i>(__left), __as<__m256i>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_mask_sub_ps(__as<__m256>(__source),
				__mask, __as<__m256>(__left), __as<__m256>(__right)));
		}
		else if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_mask_sub_pd(__as<__m256d>(__source),
...
struct _Sub<arch::ISA::AVX512VLBW, 256, _Type_> {
	...
	raze_nodiscard raze_always_inline _IntrinType_ operator()(
		...
		_IntrinType_ __right) const noexcept
	{
		return _Sub<arch::ISA::AVX512VLF, 256, _Type_>()(__left, __right);
	}
			...
			requires(__is_intrin_type_v<_MaskType_> || std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_intrin_type_v<_MaskType_> || sizeof(_Type_) >= 4) {
			...
			return __as<_IntrinType_>(_mm256_mask_sub_epi8(__as<__m256i>(__source),
				__mask, __as<__m256i>(__left), __as<__m256i>(__right)));
		}
	}
};
...
struct _Sub<arch::ISA::AVX512F, 512, _Type_> {
		...
		_IntrinType_ __right) const noexcept
	{
		if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_pd(__as<__m512d>(__left), __as<__m512d>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_ps(__as<__m512>(__left), __as<__m512>(__right)));
		}
		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_epi32(__as<__m512i>(__left), __as<__m512i>(__right)));
		}
		else if constexpr (__is_epi64_v<_Type_> || __is_epu64_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_epi64(__as<__m512i>(__left), __as<__m512i>(__right)));
		}
		else {
			const auto __low = _Sub<arch::ISA::AVX2, 256, _Type_>()(__as<__m256i>(__left), __as<__m256i>(__right));
			const auto __high = _Sub<arch::ISA::AVX2, 256, _Type_>()(
			...
			requires(__is_intrin_type_v<_MaskType_> || std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_intrin_type_v<_MaskType_> || sizeof(_Type_) < 4) {
			...
			return __as<_IntrinType_>(_mm512_mask_sub_epi64(__as<__m512i>(__source),
				__mask, __as<__m512i>(__left), __as<__m512i>(__right)));
		}
		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_mask_sub_epi32(__as<__m512i>(__source),
				__mask, __as<__m512i>(__left), __as<__m512i>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_mask_sub_ps(__as<__m512>(__source),
				__mask, __as<__m512>(__left), __as<__m512>(__right)));
		}
		else if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_mask_sub_pd(__as<__m512d>(__source),
...
struct _Sub<arch::ISA::AVX512BW, 512, _Type_> {
		...
		_IntrinType_ __right) const noexcept
	{
		if constexpr (__is_epi8_v<_Type_> || __is_epu8_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_epi8(__as<__m512i>(__left), __as<__m512i>(__right)));
		}
		else if constexpr (__is_epi16_v<_Type_> || __is_epu16_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_epi16(__as<__m512i>(__left), __as<__m512i>(__right)));
		}
		else {
			return _Sub<arch::ISA::AVX512F, 512, _Type_>()(__left, __right);
		}
	}
			...
			requires(__is_intrin_type_v<_MaskType_> || std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_intrin_type_v<_MaskType_> || sizeof(_Type_) >= 4) {
			...
			return __as<_IntrinType_>(_mm512_mask_sub_epi8(__as<__m512i>(__source),
				__mask, __as<__m512i>(__left), __as<__m512i>(__right)));
		}
	}
};
