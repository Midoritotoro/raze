...
raze_nodiscard raze_always_inline _ToVector_ __as(_FromVector_ __from) noexcept {
    ...
    else if constexpr (std::is_same_v<_RawFrom_, __m128> && std::is_same_v<_RawTo_, __m256>)    return _mm256_zextps128_ps256(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m128i> && std::is_same_v<_RawTo_, __m256>)   return _mm256_castsi256_ps(_mm256_zextsi128_si256(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128d> && std::is_same_v<_RawTo_, __m256>)   return _mm256_castpd_ps(_mm256_zextpd128_pd256(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128> && std::is_same_v<_RawTo_, __m256d>)   return _mm256_castps_pd(_mm256_zextps128_ps256(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128i> && std::is_same_v<_RawTo_, __m256d>)  return _mm256_castsi256_pd(_mm256_zextsi128_si256(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128d> && std::is_same_v<_RawTo_, __m256d>)  return _mm256_zextpd128_pd256(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m128> && std::is_same_v<_RawTo_, __m256i>)   return _mm256_castps_si256(_mm256_zextps128_ps256(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128i> && std::is_same_v<_RawTo_, __m256i>)  return _mm256_zextsi128_si256(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m128d> && std::is_same_v<_RawTo_, __m256i>)  return _mm256_castpd_si256(_mm256_zextpd128_pd256(__from));
    ...
    else if constexpr (std::is_same_v<_RawFrom_, __m256> && std::is_same_v<_RawTo_, __m512i>)   return _mm512_castps_si512(_mm512_zextps256_ps512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m256d> && std::is_same_v<_RawTo_, __m512i>)  return _mm512_castpd_si512(_mm512_zextpd256_pd512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m256i> && std::is_same_v<_RawTo_, __m512i>)  return _mm512_zextsi256_si512(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m256> && std::is_same_v<_RawTo_, __m512d>)   return _mm512_castps_pd(_mm512_zextps256_ps512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m256d> && std::is_same_v<_RawTo_, __m512d>)  return _mm512_zextpd256_pd512(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m256i> && std::is_same_v<_RawTo_, __m512d>)  return _mm512_castsi512_pd(_mm512_zextsi256_si512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m256> && std::is_same_v<_RawTo_, __m512>)    return _mm512_zextps256_ps512(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m256d> && std::is_same_v<_RawTo_, __m512>)   return _mm512_castpd_ps(_mm512_zextpd256_pd512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m256i> && std::is_same_v<_RawTo_, __m512>)   return _mm512_castsi512_ps(_mm512_zextsi256_si512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128> && std::is_same_v<_RawTo_, __m512i>)   return _mm512_castps_si512(_mm512_zextps128_ps512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128d> && std::is_same_v<_RawTo_, __m512i>)  return _mm512_castpd_si512(_mm512_zextpd128_pd512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128i> && std::is_same_v<_RawTo_, __m512i>)  return _mm512_zextsi128_si512(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m128> && std::is_same_v<_RawTo_, __m512d>)   return _mm512_castps_pd(_mm512_zextps128_ps512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128d> && std::is_same_v<_RawTo_, __m512d>)  return _mm512_zextpd128_pd512(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m128i> && std::is_same_v<_RawTo_, __m512d>)  return _mm512_castsi512_pd(_mm512_zextsi128_si512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128> && std::is_same_v<_RawTo_, __m512>)    return _mm512_zextps128_ps512(__from);
    else if constexpr (std::is_same_v<_RawFrom_, __m128d> && std::is_same_v<_RawTo_, __m512>)   return _mm512_castpd_ps(_mm512_zextpd128_pd512(__from));
    else if constexpr (std::is_same_v<_RawFrom_, __m128i> && std::is_same_v<_RawTo_, __m512>)   return _mm512_castsi512_ps(_mm512_zextsi128_si512(__from));
}
