...
struct _Mul<arch::ISA::SSE2, 128, _Type_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_pd_v<_Type_>) {
			...
			_mm_storeu_si128(reinterpret_cast<__m128i*>(&__left_array), __as<__m128i>(__left));
			_mm_storeu_si128(reinterpret_cast<__m128i*>(&__right_array), __as<__m128i>(__right));
...
template <class _Type_> struct _Mul<arch::ISA::SSE3, 128, _Type_> : _Mul<arch::ISA::SSE2, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::SSSE3, 128, _Type_> : _Mul<arch::ISA::SSE3, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::SSE41, 128, _Type_> : _Mul<arch::ISA::SSSE3, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::SSE42, 128, _Type_> : _Mul<arch::ISA::SSE41, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX, 128, _Type_> : _Mul<arch::ISA::SSE42, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX2, 128, _Type_> : _Mul<arch::ISA::AVX, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::FMA3, 128, _Type_> : _Mul<arch::ISA::AVX, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX2FMA3, 128, _Type_> : _Mul<arch::ISA::AVX2, 128, _Type_> {};

template <class _Type_> struct _Mul<arch::ISA::AVX512BW, 512, _Type_> : _Mul<arch::ISA::AVX512F, 512, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512DQ, 512, _Type_> : _Mul<arch::ISA::AVX512F, 512, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512BWDQ, 512, _Type_> : _Mul<arch::ISA::AVX512BW, 512, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMI, 512, _Type_> : _Mul<arch::ISA::AVX512BW, 512, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMI2, 512, _Type_> : _Mul<arch::ISA::AVX512VBMI, 512, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMIDQ, 512, _Type_> : _Mul<arch::ISA::AVX512BWDQ, 512, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMI2DQ, 512, _Type_> : _Mul<arch::ISA::AVX512VBMIDQ, 512, _Type_> {};

template <class _Type_> struct _Mul<arch::ISA::FMA3, 256, _Type_> : _Mul<arch::ISA::AVX, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX2FMA3, 256, _Type_> : _Mul<arch::ISA::AVX2, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VLF, 256, _Type_> : _Mul<arch::ISA::AVX2, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VLBW, 256, _Type_> : _Mul<arch::ISA::AVX512VLF, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VLDQ, 256, _Type_> : _Mul<arch::ISA::AVX512VLF, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VLBWDQ, 256, _Type_> : _Mul<arch::ISA::AVX512VLBW, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMIVL, 256, _Type_> : _Mul<arch::ISA::AVX512VLBW, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMI2VL, 256, _Type_> : _Mul<arch::ISA::AVX512VBMIVL, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMIVLDQ, 256, _Type_> : _Mul<arch::ISA::AVX512VLBWDQ, 256, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMI2VLDQ, 256, _Type_> : _Mul<arch::ISA::AVX512VBMIVLDQ, 256, _Type_> {};

template <class _Type_> struct _Mul<arch::ISA::AVX512VLF, 128, _Type_> : _Mul<arch::ISA::AVX2, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VLBW, 128, _Type_> : _Mul<arch::ISA::AVX512VLF, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VLDQ, 128, _Type_> : _Mul<arch::ISA::AVX512VLF, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VLBWDQ, 128, _Type_> : _Mul<arch::ISA::AVX512VLBW, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMIVL, 128, _Type_> : _Mul<arch::ISA::AVX512VLBW, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMI2VL, 128, _Type_> : _Mul<arch::ISA::AVX512VBMIVL, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMIVLDQ, 128, _Type_> : _Mul<arch::ISA::AVX512VLBWDQ, 128, _Type_> {};
template <class _Type_> struct _Mul<arch::ISA::AVX512VBMI2VLDQ, 128, _Type_> : _Mul<arch::ISA::AVX512VBMIVLDQ, 128, _Type_> {};
