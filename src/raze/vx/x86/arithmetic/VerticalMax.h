...
struct _Vertical_max<arch::ISA::SSE2, 128, _Type_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_epi16_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_epi16(
				__as<__m128i>(__left), 
				__as<__m128i>(__right)));
		}
		else if constexpr (__is_epu8_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_epu8(
				__as<__m128i>(__left), 
				__as<__m128i>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_ps(
				__as<__m128>(__left),
				__as<__m128>(__right)));
		}
		else if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_pd(
				__as<__m128d>(__left),
	...
	_Vertical_max<arch::ISA::SSSE3, 128, _Type_> 
{
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_epi32_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_epi32(
				__as<__m128i>(__left), 
				__as<__m128i>(__right)));
		}
		else if constexpr (__is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_epu32(
				__as<__m128i>(__left),
				__as<__m128i>(__right)));
		}
		else if constexpr (__is_epu16_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_epu16(
				__as<__m128i>(__left),
				__as<__m128i>(__right)));
		}
		else if constexpr (__is_epi8_v<_Type_>) {
			return __as<_IntrinType_>(_mm_max_epi8(
				__as<__m128i>(__left), 
				__as<__m128i>(__right)));
		}
		else {
...
struct _Vertical_max<arch::ISA::AVX, 256, _Type_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_ps(
				__as<__m256>(__left),
				__as<__m256>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_pd(
				__as<__m256d>(__left),
...
struct _Vertical_max<arch::ISA::AVX2, 256, _Type_> {
	...
	{
		if constexpr (__is_epi32_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_epi32(
				__as<__m256i>(__left),
				__as<__m256i>(__right)));
		}
		else if constexpr (__is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_epu32(
				__as<__m256i>(__left),
				__as<__m256i>(__right)));
		}
		else if constexpr (__is_epi16_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_epi16(
				__as<__m256i>(__left),
				__as<__m256i>(__right)));
		}
		else if constexpr (__is_epu16_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_epu16(
				__as<__m256i>(__left),
				__as<__m256i>(__right)));
		}
		else if constexpr (__is_epi8_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_epi8(
				__as<__m256i>(__left), 
				__as<__m256i>(__right)));
		}
		else if constexpr (__is_epu8_v<_Type_>) {
			return __as<_IntrinType_>(_mm256_max_epu8(
				__as<__m256i>(__left), 
				__as<__m256i>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
...
struct _Vertical_max<arch::ISA::AVX512F, 512, _Type_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_epi64_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_max_epi64(
				__as<__m512i>(__left),
				__as<__m512i>(__right)));
		}
		else if constexpr (__is_epu64_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_max_epu64(
				__as<__m512i>(__left), 
				__as<__m512i>(__right)));
		}
		else if constexpr (__is_epi32_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_max_epi32(
				__as<__m512i>(__left), 
				__as<__m512i>(__right)));
		}
		else if constexpr (__is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_max_epu32(
				__as<__m512i>(__left), 
				__as<__m512i>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_max_ps(
				__as<__m512>(__left),
				__as<__m512>(__right)));
		}
		else if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_max_pd(
				__as<__m512d>(__left),
	...
	_Vertical_max<arch::ISA::AVX512F, 512, _Type_> 
{
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_epi8_v<_Type_>)
			return __as<_IntrinType_>(_mm512_max_epi8(
				__as<__m512i>(__left),
				__as<__m512i>(__right)));

		else if constexpr (__is_epu8_v<_Type_>)
			return __as<_IntrinType_>(_mm512_max_epu8(
				__as<__m512i>(__left),
				__as<__m512i>(__right)));

		else if constexpr (__is_epi16_v<_Type_>)
			return __as<_IntrinType_>(_mm512_max_epi16(
				__as<__m512i>(__left),
				__as<__m512i>(__right)));

		else if constexpr (__is_epu16_v<_Type_>)
			return __as<_IntrinType_>(_mm512_max_epu16(
				__as<__m512i>(__left), 
				__as<__m512i>(__right)));
	...
	_Vertical_max<arch::ISA::AVX2, 256, _Type_> 
{
	...
	{
		if constexpr (__is_epi64_v<_Type_>)
			return __as<_IntrinType_>(_mm256_max_epi64(
				__as<__m256i>(__left),
				__as<__m256i>(__right)));

		else if constexpr (__is_epu64_v<_Type_>)
			return __as<_IntrinType_>(_mm256_max_epu64(
				__as<__m256i>(__left), 
				__as<__m256i>(__right)));
	...
	_Vertical_max<arch::ISA::SSE42, 128, _Type_> 
{
	...
	{
		if constexpr (__is_epi64_v<_Type_>)
			return __as<_IntrinType_>(_mm_max_epi64(
				__as<__m128i>(__left),
				__as<__m128i>(__right)));

		else if constexpr (__is_epu64_v<_Type_>)
			return __as<_IntrinType_>(_mm_max_epu64(
				__as<__m128i>(__left), 
				__as<__m128i>(__right)));
...
template <class _Type_> struct _Vertical_max<arch::ISA::AVX512VLBW, 256, _Type_> : _Vertical_max<arch::ISA::AVX512VLF, 256, _Type_> {};
...
template <class _Type_> struct _Vertical_max<arch::ISA::AVX512VLBW, 128, _Type_> : _Vertical_max<arch::ISA::AVX512VLF, 128, _Type_> {};
