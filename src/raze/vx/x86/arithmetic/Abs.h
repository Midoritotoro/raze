...
struct _Abs<arch::ISA::AVX512BW, 512, _Type_>:
	_Abs<arch::ISA::AVX512F, 512, _Type_> 
{
	template <class _IntrinType_>
	raze_nodiscard raze_static_operator raze_always_inline
		_IntrinType_ operator()(_IntrinType_ __vector) raze_const_operator noexcept
...
template <class _Type_> struct _Abs<arch::ISA::SSE41, 128, _Type_>: _Abs<arch::ISA::SSSE3, 128, _Type_> {};
...
template <class _Type_> struct _Abs<arch::ISA::AVX512VLBW, 256, _Type_>: _Abs<arch::ISA::AVX512VLF, 256, _Type_> {};
...
template <class _Type_> struct _Abs<arch::ISA::AVX512VLBW, 128, _Type_>: _Abs<arch::ISA::AVX512VLF, 128, _Type_> {};
