...
struct _Sub<arch::ISA::AVX2, 256, _Type_> {
	...
	{
		if constexpr (__is_epi64_v<_Type_> || __is_epu64_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi64(
				__as<__m256i>(__left),
				__as<__m256i>(__right)));

		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi32(
				__as<__m256i>(__left),
				__as<__m256i>(__right)));

		else if constexpr (__is_epi16_v<_Type_> || __is_epu16_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi16(
				__as<__m256i>(__left), 
				__as<__m256i>(__right)));

		else if constexpr (__is_epi8_v<_Type_> || __is_epu8_v<_Type_>)
			return __as<_IntrinType_>(_mm256_sub_epi8(
				__as<__m256i>(__left), 
				__as<__m256i>(__right)));
...
struct _Sub<arch::ISA::AVX512F, 512, _Type_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_pd_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_pd(
				__as<__m512d>(__left), 
				__as<__m512d>(__right)));
		}
		else if constexpr (__is_ps_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_ps(
				__as<__m512>(__left), 
				__as<__m512>(__right)));
		}
		else if constexpr (__is_epi32_v<_Type_> || __is_epu32_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_epi32(
				__as<__m512i>(__left),
				__as<__m512i>(__right)));
		}
		else if constexpr (__is_epi64_v<_Type_> || __is_epu64_v<_Type_>) {
			return __as<_IntrinType_>(_mm512_sub_epi64(
				__as<__m512i>(__left), 
				__as<__m512i>(__right)));
		}
		else {
			const auto __low	= _Sub<arch::ISA::AVX2, 256, _Type_>()(
...
template <class _Type_> struct _Sub<arch::ISA::SSE41, 128, _Type_>: _Sub<arch::ISA::SSSE3, 128, _Type_> {};
...
template <class _Type_> struct _Sub<arch::ISA::AVX512BW, 512, _Type_>: _Sub<arch::ISA::AVX512F, 512, _Type_> {};
...
template <class _Type_> struct _Sub<arch::ISA::AVX512VLF, 256, _Type_>: _Sub<arch::ISA::AVX2, 256, _Type_> {};
template <class _Type_> struct _Sub<arch::ISA::AVX512VLBW, 256, _Type_>: _Sub<arch::ISA::AVX512VLF, 256, _Type_> {};
...
template <class _Type_> struct _Sub<arch::ISA::AVX512VLF, 128, _Type_>: _Sub<arch::ISA::AVX2, 128, _Type_> {};
template <class _Type_> struct _Sub<arch::ISA::AVX512VLBW, 128, _Type_>: _Sub<arch::ISA::AVX512VLF, 128, _Type_> {};
