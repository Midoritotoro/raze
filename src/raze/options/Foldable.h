...
struct foldable {
    ...
    friend constexpr raze_always_inline auto operator>>(foldable&& __x,  foldable<_Function_, _OtherType_>&& __y) noexcept {
    ...
    template <class _OtherType_>
    friend constexpr raze_always_inline decltype(auto) operator<<(foldable&& __x, foldable<_Function_, _OtherType_>&& __y) noexcept {
        using _ReturnType = decltype(std::invoke(__x._function, __x._value, __y._value));
        return foldable<_Function_, std::decay_t<_ReturnType>>{__x._function,
            std::invoke(__x._function, __x._value, __y._value)};
    }
...
constexpr raze_always_inline auto fold_left(_Function_&& __function, _Type_&& __tuple, _Value_ __init) noexcept {
