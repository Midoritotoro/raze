...
struct _Mask_add<arch::ISA::SSE2, 128, _DesiredType_> {
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_add<arch::ISA::SSSE3, 128, _DesiredType_>:
	_Mask_add<arch::ISA::SSE3, 128, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_add<arch::ISA::SSE41, 128, _DesiredType_>:
	_Mask_add<arch::ISA::SSSE3, 128, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_add<arch::ISA::AVX512VLF, 128, _DesiredType_>: 
	_Mask_add<arch::ISA::AVX2, 128, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
			...
			requires(std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm_mask_add_epi64(
			...
			return __intrin_bitcast<_IntrinType_>(_mm_mask_add_epi32(
				__intrin_bitcast<__m128i>(__additional_source),  __mask, 
				__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right)));

		else if constexpr (__is_ps_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm_mask_add_ps(
			...
			return __intrin_bitcast<_IntrinType_>(_mm_mask_add_pd(
...
template <class _DesiredType_> 
struct _Mask_add<arch::ISA::AVX512VLBW, 128, _DesiredType_>:
	_Mask_add<arch::ISA::AVX512VLF, 128, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_>
			...
			requires(std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_epi16_v<_DesiredType_> || __is_epu16_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm_mask_add_epi16(
				__intrin_bitcast<__m128i>(__additional_source), __mask,
				__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right)));

		else if constexpr (__is_epi8_v<_DesiredType_> || __is_epu8_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm_mask_add_epi8(
				__intrin_bitcast<__m128i>(__additional_source), __mask,
				__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right)));

		else
			return _Mask_add<arch::ISA::AVX512VLF, 128, _DesiredType_>()(
...
template <class _DesiredType_> 
struct _Mask_add<arch::ISA::AVX512VLF, 256, _DesiredType_>:
	_Mask_add<arch::ISA::AVX2, 256, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_add<arch::ISA::AVX512VLBW, 256, _DesiredType_>: 
	_Mask_add<arch::ISA::AVX512VLF, 256, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_>
	...
	{
		if constexpr (__is_epi16_v<_DesiredType_> || __is_epu16_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm256_mask_add_epi16(
				__intrin_bitcast<__m256i>(__additional_source), __mask,
				__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right)));

		else if constexpr (__is_epi8_v<_DesiredType_> || __is_epu8_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm256_mask_add_epi8(
				__intrin_bitcast<__m256i>(__additional_source), __mask,
				__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right)));

		else
			return _Mask_add<arch::ISA::AVX512VLF, 256, _DesiredType_>()(
				__left, __right, __mask, __additional_source);
	}
};

template <class _DesiredType_>
struct _Mask_add<arch::ISA::AVX512F, 512, _DesiredType_> {
	template <
		class _IntrinType_,
		class _MaskType_>
	raze_nodiscard raze_static_operator raze_always_inline _IntrinType_ operator()(
...
template <class _DesiredType_> 
struct _Mask_add<arch::ISA::AVX512BW, 512, _DesiredType_>: 
	_Mask_add<arch::ISA::AVX512F, 512, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
	...
	{
		if constexpr (__is_epi16_v<_DesiredType_> || __is_epu16_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm512_mask_add_epi16(
				__intrin_bitcast<__m512i>(__additional_source), __mask,
				__intrin_bitcast<__m512i>(__left), __intrin_bitcast<__m512i>(__right)));

		else if constexpr (__is_epi8_v<_DesiredType_> || __is_epu8_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm512_mask_add_epi8(
				__intrin_bitcast<__m512i>(__additional_source), __mask,
				__intrin_bitcast<__m512i>(__left), __intrin_bitcast<__m512i>(__right)));

		else
			return _Mask_add<arch::ISA::AVX512F, 512, _DesiredType_>()(
				__left, __right, __mask, __additional_source);
	}
};
...
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMI, 512, _DesiredType_> : _Mask_add<arch::ISA::AVX512BW, 512, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMI2, 512, _DesiredType_> : _Mask_add<arch::ISA::AVX512VBMI, 512, _DesiredType_> {};
...
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMI2VL, 256, _DesiredType_> : _Mask_add<arch::ISA::AVX512VBMIVL, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMIVLDQ, 256, _DesiredType_> : _Mask_add<arch::ISA::AVX512VLBWDQ, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMI2VLDQ, 256, _DesiredType_> : _Mask_add<arch::ISA::AVX512VBMIVLDQ, 256, _DesiredType_> {};

template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VLDQ, 128, _DesiredType_> : _Mask_add<arch::ISA::AVX512VLF, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VLBWDQ, 128, _DesiredType_> : _Mask_add<arch::ISA::AVX512VLBW, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMIVL, 128, _DesiredType_> : _Mask_add<arch::ISA::AVX512VLBW, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMI2VL, 128, _DesiredType_> : _Mask_add<arch::ISA::AVX512VBMIVL, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMIVLDQ, 128, _DesiredType_> : _Mask_add<arch::ISA::AVX512VLBWDQ, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_add<arch::ISA::AVX512VBMI2VLDQ, 128, _DesiredType_> : _Mask_add<arch::ISA::AVX512VBMIVLDQ, 128, _DesiredType_> {};
