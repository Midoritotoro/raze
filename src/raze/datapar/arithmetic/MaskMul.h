...
struct _Mask_mul<arch::ISA::SSE2, 128, _DesiredType_> {
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_mul<arch::ISA::SSSE3, 128, _DesiredType_>:
	_Mask_mul<arch::ISA::SSE3, 128, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_mul<arch::ISA::SSE41, 128, _DesiredType_>:
	_Mask_mul<arch::ISA::SSSE3, 128, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_mul<arch::ISA::AVX512VLF, 128, _DesiredType_>: 
	_Mask_mul<arch::ISA::AVX2, 128, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
			...
			requires(std::is_integral_v<_MaskType_>)
	{
		if constexpr (__is_ps_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm_mask_mul_ps(
			...
			return __intrin_bitcast<_IntrinType_>(_mm_mask_mul_pd(
...
template <class _DesiredType_> 
struct _Mask_mul<arch::ISA::AVX512VLBW, 128, _DesiredType_>:
	_Mask_mul<arch::ISA::AVX512VLF, 128, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_mul<arch::ISA::AVX512VLF, 256, _DesiredType_>:
	_Mask_mul<arch::ISA::AVX2, 256, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> 
struct _Mask_mul<arch::ISA::AVX512VLBW, 256, _DesiredType_>: 
	_Mask_mul<arch::ISA::AVX512VLF, 256, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_>
	...
	{
		if constexpr (__is_epi16_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm256_mask_mullo_epi16(
				__intrin_bitcast<__m256i>(__additional_source), __mask,
				__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right)));

		else
			return _Mask_mul<arch::ISA::AVX512VLF, 256, _DesiredType_>()(
				__left, __right, __mask, __additional_source);
	}
};

template <class _DesiredType_>
struct _Mask_mul<arch::ISA::AVX512F, 512, _DesiredType_> {
	template <
		class _IntrinType_,
		class _MaskType_>
	raze_nodiscard raze_static_operator raze_always_inline _IntrinType_ operator()(
...
template <class _DesiredType_> 
struct _Mask_mul<arch::ISA::AVX512BW, 512, _DesiredType_>: 
	_Mask_mul<arch::ISA::AVX512F, 512, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_>
...
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMI, 512, _DesiredType_> : _Mask_mul<arch::ISA::AVX512BW, 512, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMI2, 512, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VBMI, 512, _DesiredType_> {};
...
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMI2VL, 256, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VBMIVL, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMIVLDQ, 256, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VLBWDQ, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMI2VLDQ, 256, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VBMIVLDQ, 256, _DesiredType_> {};

template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VLDQ, 128, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VLF, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VLBWDQ, 128, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VLBW, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMIVL, 128, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VLBW, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMI2VL, 128, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VBMIVL, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMIVLDQ, 128, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VLBWDQ, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_mul<arch::ISA::AVX512VBMI2VLDQ, 128, _DesiredType_> : _Mask_mul<arch::ISA::AVX512VBMIVLDQ, 128, _DesiredType_> {};
