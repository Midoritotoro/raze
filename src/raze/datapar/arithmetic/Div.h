...
struct _Div<arch::ISA::SSE2, 128, _DesiredType_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_pd_v<_DesiredType_>) {
			...
			const auto __divisor_information = _Divisor<int32>(
			...
			const auto __divisor_information = _Divisor<uint32>(
				_mm_cvtsi128_si32(__intrin_bitcast<__m128i>(__right)));
			...
			const auto __divisor_information = _Divisor<int16>(
				_mm_cvtsi128_si32(__intrin_bitcast<__m128i>(__right)) & 0xFFFF);
			...
			const auto __divisor_information = _Divisor<uint16>(
				static_cast<uint16>(_mm_cvtsi128_si32(__intrin_bitcast<__m128i>(__right)) & 0xFFFF));
			...
			const auto __16bit_divisor = _mm_set1_epi16(_mm_cvtsi128_si32(__right) & 0xFF);

			const auto __low = _Div<arch::ISA::SSE2, 128, int16>()(_mm_unpacklo_epi8(
				__intrin_bitcast<__m128i>(__left), __sign), __16bit_divisor);
			...
			const auto __low = _Div<arch::ISA::SSE2, 128, uint16>()(__low_part, __16bit_divisor);
			const auto __high = _Div<arch::ISA::SSE2, 128, uint16>()(__high_part, __16bit_divisor);
...
struct _Div<arch::ISA::AVX2, 256, _DesiredType_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>) {
			...
			const auto __divisor_information = _Divisor<int32>(
				_mm256_cvtsi256_si32(__intrin_bitcast<__m256i>(__right)));
			...
			const auto __16bit_divisor = _mm256_set1_epi16(_mm256_cvtsi256_si32(__intrin_bitcast<__m256i>(__right)) & 0xFF);
			...
			const auto __divided_low = _Div<arch::ISA::AVX2, 256, int16>()(__low, __16bit_divisor);
			const auto __divided_high = _Div<arch::ISA::AVX2, 256, int16>()(__high, __16bit_divisor);
...
struct _Div<arch::ISA::AVX512F, 512, _DesiredType_> {
		...
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_epi32_v<_DesiredType_>) {
			const auto __divisor_information = _Divisor<int32>(
				_mm512_cvtsi512_si32(__intrin_bitcast<__m512i>(__right)));
