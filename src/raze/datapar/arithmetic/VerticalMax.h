...
template <class _DesiredType_> 
struct _Vertical_max<arch::ISA::AVX, 256, _DesiredType_> {
	template <class _IntrinType_>
	raze_nodiscard raze_static_operator raze_always_inline _IntrinType_ operator()(
		_IntrinType_ __left,
		_IntrinType_ __right) raze_const_operator noexcept
	{
		if constexpr (__is_ps_v<_DesiredType_>) {
			...
			const auto __mask = _Greater<arch::ISA::AVX, 256, _DesiredType_>()(__left, __right);
	...
	_Vertical_max<arch::ISA::AVX2, 256, _DesiredType_> 
{
	...
	{
		if constexpr (__is_epi64_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm256_max_epi64(
				__intrin_bitcast<__m256i>(__left),
				__intrin_bitcast<__m256i>(__right)));
	...
	_Vertical_max<arch::ISA::SSE42, 128, _DesiredType_> 
{
	...
	{
		if constexpr (__is_epi64_v<_DesiredType_>)
			return __intrin_bitcast<_IntrinType_>(_mm_max_epi64(
				__intrin_bitcast<__m128i>(__left),
				__intrin_bitcast<__m128i>(__right)));
...
template <class _DesiredType_> struct _Vertical_max<arch::ISA::AVX, 128, _DesiredType_> : _Vertical_max<arch::ISA::SSE42, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Vertical_max<arch::ISA::AVX2, 128, _DesiredType_> : _Vertical_max<arch::ISA::AVX, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Vertical_max<arch::ISA::FMA3, 128, _DesiredType_> : _Vertical_max<arch::ISA::AVX, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Vertical_max<arch::ISA::AVX2FMA3, 128, _DesiredType_> : _Vertical_max<arch::ISA::AVX2, 128, _DesiredType_> {};
...
template <class _DesiredType_> struct _Vertical_max<arch::ISA::FMA3, 256, _DesiredType_> : _Vertical_max<arch::ISA::AVX, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Vertical_max<arch::ISA::AVX2FMA3, 256, _DesiredType_> : _Vertical_max<arch::ISA::AVX2, 256, _DesiredType_> {};
