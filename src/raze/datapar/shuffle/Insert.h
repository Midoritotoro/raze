...
struct _Insert<arch::ISA::SSE2, 128> {
		...
		_DesiredType_	__value) raze_const_operator noexcept 
	{
        if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>) {
            ...
            switch (__index) {
                case 0:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 0));
                    break;
                case 1:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 1));
                    break;
                case 2:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 2));
                    break;
                case 3:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 3));
                    break;
                case 4:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 4));
                    break;
                case 5:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 5));
                    break;
                case 6:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 6));
                    break;
                default:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi16(
                        __intrin_bitcast<__m128i>(__vector), __value, 7));
                    break;
            }
        }
    ...
    _Insert<arch::ISA::SSSE3, 128> 
{
        ...
        _DesiredType_	__value) raze_const_operator noexcept
    {
        if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>) {
            ...
            switch (__index) {
                case 0:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi64(
                        __intrin_bitcast<__m128i>(__vector), __qword_value, 0));
                    break;
                default:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi64(
                        __intrin_bitcast<__m128i>(__vector), __qword_value, 1));
                    break;
            }
        }
            ...
            switch (__index) {
                case 0:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi32(
                        __intrin_bitcast<__m128i>(__vector), __dword_value, 0));
                    break;
                case 1:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi32(
                        __intrin_bitcast<__m128i>(__vector), __dword_value, 1));
                    break;
                case 2:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi32(
                        __intrin_bitcast<__m128i>(__vector), __dword_value, 2));
                    break;
                default:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm_insert_epi32(
                        __intrin_bitcast<__m128i>(__vector), __dword_value, 3));
                    break;
            }
        }
        else if constexpr (__is_epi16_v<_DesiredType_> || __is_epu16_v<_DesiredType_>) {
    ...
    _Insert<arch::ISA::AVX, 256> 
{
        ...
        _DesiredType_	__value) raze_const_operator noexcept
    {
        if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>) {
            ...
            switch (__index) {
                case 0:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm256_blend_epi32(
                        __intrin_bitcast<__m256i>(__vector), __broadcasted, 0x03));
                    break;
                case 1:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm256_blend_epi32(
                        __intrin_bitcast<__m256i>(__vector), __broadcasted, 0x0C));
                    break;
                case 2:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm256_blend_epi32(
                        __intrin_bitcast<__m256i>(__vector), __broadcasted, 0x30));
                    break;
                default:
                    __vector = __intrin_bitcast<_IntrinType_>(_mm256_blend_epi32(
                        __intrin_bitcast<__m256i>(__vector), __broadcasted, 0xC0));
                    break;
            }
        }
        else {
    ...
    _Insert<arch::ISA::AVX2, 256> 
{
    ...
    {
        if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>) {
            __vector = __intrin_bitcast<_IntrinType_>(_mm256_mask_set1_epi64(
                __intrin_bitcast<__m256i>(__vector),
                static_cast<uint8>(uint8(1) << __index),
                memory::pointer_to_integral(__value)));
        }
        else if constexpr (__is_epi32_v<_DesiredType_> || __is_epu32_v<_DesiredType_>) {
            __vector = __intrin_bitcast<_IntrinType_>(_mm256_mask_set1_epi32(
                __intrin_bitcast<__m256i>(__vector), 
                static_cast<uint8>(uint8(1) << __index),
                memory::pointer_to_integral(__value)));
        }
        else if constexpr (__is_ps_v<_DesiredType_>) {
            __vector = __intrin_bitcast<_IntrinType_>(_mm256_mask_broadcastss_ps(
                __intrin_bitcast<__m256>(__vector),
                static_cast<uint8>(uint8(1) << __index),
                _mm_set_ss(__value)));
        }
        else if constexpr (__is_pd_v<_DesiredType_>) {
            __vector = __intrin_bitcast<_IntrinType_>(_mm256_mask_broadcastsd_pd(
            ...
            __vector = _Blend<arch::ISA::AVX512VLF, 256, _DesiredType_>()(__broadcasted, __vector, __insert_mask);
        }
    }
};
    ...
    _Insert<arch::ISA::AVX512VLF, 256> 
{
        ...
        _DesiredType_	__value) raze_const_operator noexcept
    {
        if constexpr (sizeof(_DesiredType_) >= 4)
            ...
            __vector = __intrin_bitcast<_IntrinType_>(_mm256_mask_set1_epi16(
                __intrin_bitcast<__m256i>(__vector),
                static_cast<uint16>(uint16(1) << __index), 
                memory::pointer_to_integral(__value)));

        else if constexpr (__is_epi8_v<_DesiredType_> || __is_epu8_v<_DesiredType_>)
            __vector = __intrin_bitcast<_IntrinType_>(_mm256_mask_set1_epi8(
                __intrin_bitcast<__m256i>(__vector),
    ...
    _Insert<arch::ISA::AVX512F, 512> 
{
        ...
        _DesiredType_	__value) raze_const_operator noexcept
    {
        if constexpr (sizeof(_DesiredType_) >= 4)
            ...
            __vector = __intrin_bitcast<_IntrinType_>(_mm512_mask_set1_epi16(
                __intrin_bitcast<__m512i>(__vector), 
                static_cast<uint32>(uint32(1) << __index), 
                memory::pointer_to_integral(__value)));

        else if constexpr (__is_epi8_v<_DesiredType_> || __is_epu8_v<_DesiredType_>)
            __vector = __intrin_bitcast<_IntrinType_>(_mm512_mask_set1_epi8(
                __intrin_bitcast<__m512i>(__vector),
