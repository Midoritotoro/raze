...
struct _Mask_store<arch::ISA::SSE2, 128, _DesiredType_> {
	template <
		class _IntrinType_,
		class _MaskType_,
...
struct _Mask_store<arch::ISA::SSE41, 128, _DesiredType_>:
	_Mask_store<arch::ISA::SSSE3, 128, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_,
...
template <class _DesiredType_>
struct _Mask_store<arch::ISA::AVX512BW, 512, _DesiredType_>: 
	_Mask_store<arch::ISA::AVX512F, 512, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_,
...
template <class _DesiredType_>
struct _Mask_store<arch::ISA::AVX512VLF, 256, _DesiredType_>: 
	_Mask_store<arch::ISA::AVX2, 256, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_,
			...
			requires(std::is_integral_v<_MaskType_> || __is_intrin_type_v<_MaskType_>)
	{
		if constexpr (__is_intrin_type_v<_MaskType_>) {
			return _Mask_store<arch::ISA::AVX2, 256, _DesiredType_>()(__address, __mask, __vector, __alignment_policy);
		}
		else {
			if constexpr (std::remove_cvref_t<_AlignmentPolicy_>::__alignment) {
				if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>)
...
template <class _DesiredType_> 
struct _Mask_store<arch::ISA::AVX512VLF, 128, _DesiredType_>: 
	_Mask_store<arch::ISA::AVX2, 128, _DesiredType_> 
{
	template <
		class _IntrinType_,
		class _MaskType_,
	...
	{
		if constexpr (__is_intrin_type_v<_MaskType_>) {
			return _Mask_store<arch::ISA::AVX2, 128, _DesiredType_>()(__address, __mask, __vector, __alignment_policy);
		}
		else {
			if constexpr (std::remove_cvref_t<_AlignmentPolicy_>::__alignment) {
				if constexpr (__is_epi64_v<_DesiredType_> || __is_epu64_v<_DesiredType_>)
...
template <class _DesiredType_>
struct _Mask_store<arch::ISA::AVX512VLBW, 128, _DesiredType_>:
	_Mask_store<arch::ISA::AVX512VLF, 128, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_,
...
template <class _DesiredType_>
struct _Mask_store<arch::ISA::AVX512VLBW, 256, _DesiredType_> :
	_Mask_store<arch::ISA::AVX512VLF, 256, _DesiredType_>
{
	template <
		class _IntrinType_,
		class _MaskType_,
...
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMI, 512, _DesiredType_> : _Mask_store<arch::ISA::AVX512BW, 512, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMI2, 512, _DesiredType_> : _Mask_store<arch::ISA::AVX512VBMI, 512, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMIDQ, 512, _DesiredType_> : _Mask_store<arch::ISA::AVX512BWDQ, 512, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMI2DQ, 512, _DesiredType_> : _Mask_store<arch::ISA::AVX512VBMIDQ, 512, _DesiredType_> {};
;
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VLDQ, 256, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLF, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VLBWDQ, 256, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLBW, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMIVL, 256, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLBW, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMI2VL, 256, _DesiredType_> : _Mask_store<arch::ISA::AVX512VBMIVL, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMIVLDQ, 256, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLBWDQ, 256, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMI2VLDQ, 256, _DesiredType_> : _Mask_store<arch::ISA::AVX512VBMIVLDQ, 256, _DesiredType_> {};

template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VLDQ, 128, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLF, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VLBWDQ, 128, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLBW, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMIVL, 128, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLBW, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMI2VL, 128, _DesiredType_> : _Mask_store<arch::ISA::AVX512VBMIVL, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMIVLDQ, 128, _DesiredType_> : _Mask_store<arch::ISA::AVX512VLBWDQ, 128, _DesiredType_> {};
template <class _DesiredType_> struct _Mask_store<arch::ISA::AVX512VBMI2VLDQ, 128, _DesiredType_> : _Mask_store<arch::ISA::AVX512VBMIVLDQ, 128, _DesiredType_> {};
