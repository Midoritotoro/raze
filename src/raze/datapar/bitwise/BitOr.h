...
template <>
struct _Or<arch::ISA::AVX512F, 512> {
	template <class _IntrinType_>
	raze_nodiscard raze_static_operator raze_always_inline _IntrinType_ operator()(
		_IntrinType_ __left,
		_IntrinType_ __right) raze_const_operator noexcept
...
template <> struct _Or<arch::ISA::SSE3, 128> : _Or<arch::ISA::SSE2, 128> {};
...
template <> struct _Or<arch::ISA::AVX512BWDQ, 512> : _Or<arch::ISA::AVX512BW, 512> {};
template <> struct _Or<arch::ISA::AVX512VBMI, 512> : _Or<arch::ISA::AVX512BW, 512> {};
template <> struct _Or<arch::ISA::AVX512VBMI2, 512> : _Or<arch::ISA::AVX512VBMI, 512> {};
...
template <> struct _Or<arch::ISA::AVX512VLBWDQ, 256> : _Or<arch::ISA::AVX512VLBW, 256> {};
template <> struct _Or<arch::ISA::AVX512VBMIVL, 256> : _Or<arch::ISA::AVX512VLBW, 256> {};
template <> struct _Or<arch::ISA::AVX512VBMI2VL, 256> : _Or<arch::ISA::AVX512VBMIVL, 256> {};
template <> struct _Or<arch::ISA::AVX512VBMIVLDQ, 256> : _Or<arch::ISA::AVX512VLBWDQ, 256> {};
template <> struct _Or<arch::ISA::AVX512VBMI2VLDQ, 256> : _Or<arch::ISA::AVX512VBMIVLDQ, 256> {};

template <> struct _Or<arch::ISA::AVX512VLF, 128> : _Or<arch::ISA::AVX2, 128> {};
template <> struct _Or<arch::ISA::AVX512VLBW, 128> : _Or<arch::ISA::AVX512VLF, 128> {};
template <> struct _Or<arch::ISA::AVX512VLDQ, 128> : _Or<arch::ISA::AVX512VLF, 128> {};
template <> struct _Or<arch::ISA::AVX512VLBWDQ, 128> : _Or<arch::ISA::AVX512VLBW, 128> {};
template <> struct _Or<arch::ISA::AVX512VBMIVL, 128> : _Or<arch::ISA::AVX512VLBW, 128> {};
template <> struct _Or<arch::ISA::AVX512VBMI2VL, 128> : _Or<arch::ISA::AVX512VBMIVL, 128> {};
template <> struct _Or<arch::ISA::AVX512VBMIVLDQ, 128> : _Or<arch::ISA::AVX512VLBWDQ, 128> {};
template <> struct _Or<arch::ISA::AVX512VBMI2VLDQ, 128> : _Or<arch::ISA::AVX512VBMIVLDQ, 128> {};
