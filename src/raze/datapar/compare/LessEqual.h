...
template <class _DesiredType_> 
struct _Simd_less_equal<arch::ISA::AVX512BW, 512, _DesiredType_>:
    _Simd_less_equal<arch::ISA::AVX512F, 512, _DesiredType_> 
{
    template <class _IntrinType_>
    raze_nodiscard raze_static_operator raze_always_inline auto operator()(
        _IntrinType_ __left,
        _IntrinType_ __right) raze_const_operator noexcept
    {
        if constexpr (__is_epi8_v<_DesiredType_>)
            return _mm512_cmple_epi8_mask(__intrin_bitcast<__m512i>(__left), __intrin_bitcast<__m512i>(__right));

        else if constexpr (__is_epu8_v<_DesiredType_>)
            return _mm512_cmple_epu8_mask(__intrin_bitcast<__m512i>(__left), __intrin_bitcast<__m512i>(__right));

        else if constexpr (__is_epi16_v<_DesiredType_>)
            return _mm512_cmple_epi16_mask(__intrin_bitcast<__m512i>(__left), __intrin_bitcast<__m512i>(__right));

        else if constexpr (__is_epu16_v<_DesiredType_>)
            return _mm512_cmple_epu16_mask(__intrin_bitcast<__m512i>(__left), __intrin_bitcast<__m512i>(__right));

        else
            return _Simd_less_equal<arch::ISA::AVX512F, 512, _DesiredType_>()(__left, __right);
    }
};

template <class _DesiredType_> 
struct _Simd_less_equal<arch::ISA::AVX512VLF, 256, _DesiredType_>: 
    _Simd_less_equal<arch::ISA::AVX2, 256, _DesiredType_> 
{
    template <class _IntrinType_>
    raze_nodiscard raze_static_operator raze_always_inline auto operator()(
        _IntrinType_ __left,
    ...
    {
        if constexpr (__is_epi64_v<_DesiredType_>) {
            return _mm256_cmple_epi64_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));
        }
        else if constexpr (__is_epu64_v<_DesiredType_>) {
            return _mm256_cmple_epu64_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));
        }
        else if constexpr (__is_epi32_v<_DesiredType_>) {
            return _mm256_cmple_epi32_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));
        }
        else if constexpr (__is_epu32_v<_DesiredType_>) {
            return _mm256_cmple_epu32_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));
        }
        else if constexpr (__is_pd_v<_DesiredType_>) {
            return _mm256_cmp_pd_mask(__intrin_bitcast<__m256d>(__left), __intrin_bitcast<__m256d>(__right), _CMP_LE_OQ);
        }
        else if constexpr (__is_ps_v<_DesiredType_>) {
            return _mm256_cmp_ps_mask(__intrin_bitcast<__m256>(__left), __intrin_bitcast<__m256>(__right), _CMP_LE_OQ);
        }
        else {
            return _Simd_less_equal<arch::ISA::AVX2, 256, _DesiredType_>()(__left, __right);
        }
    }
};
...
template <class _DesiredType_> 
struct _Simd_less_equal<arch::ISA::AVX512VLBW, 256, _DesiredType_>:
    _Simd_less_equal<arch::ISA::AVX512VLF, 256, _DesiredType_>
{
    template <class _IntrinType_>
    raze_nodiscard raze_static_operator raze_always_inline auto operator()(
        _IntrinType_ __left,
    ...
    {
        if constexpr (__is_epi8_v<_DesiredType_>)
            return _mm256_cmple_epi8_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));

        else if constexpr (__is_epu8_v<_DesiredType_>)
            return _mm256_cmple_epu8_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));

        else if constexpr (__is_epi16_v<_DesiredType_>)
            return _mm256_cmple_epi16_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));

        else if constexpr (__is_epu16_v<_DesiredType_>)
            return _mm256_cmple_epu16_mask(__intrin_bitcast<__m256i>(__left), __intrin_bitcast<__m256i>(__right));
        
        else
            return _Simd_less_equal<arch::ISA::AVX512VLF, 256, _DesiredType_>()(__left, __right);
    }
};

template <class _DesiredType_>
struct _Simd_less_equal<arch::ISA::AVX512VLF, 128, _DesiredType_> :
    _Simd_less_equal<arch::ISA::AVX2, 128, _DesiredType_>
{
    template <class _IntrinType_>
    raze_nodiscard raze_static_operator raze_always_inline auto operator()(
        _IntrinType_ __left,
    ...
    {
        if constexpr (__is_epi64_v<_DesiredType_>) {
            return _mm_cmple_epi64_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));
        }
        else if constexpr (__is_epu64_v<_DesiredType_>) {
            return _mm_cmple_epu64_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));
        }
        else if constexpr (__is_epi32_v<_DesiredType_>) {
            return _mm_cmple_epi32_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));
        }
        else if constexpr (__is_epu32_v<_DesiredType_>) {
            return _mm_cmple_epu32_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));
        }
        else if constexpr (__is_pd_v<_DesiredType_>) {
            return _mm_cmp_pd_mask(__intrin_bitcast<__m128d>(__left), __intrin_bitcast<__m128d>(__right), _CMP_LE_OQ);
        }
        else if constexpr (__is_ps_v<_DesiredType_>) {
            return _mm_cmp_ps_mask(__intrin_bitcast<__m128>(__left), __intrin_bitcast<__m128>(__right), _CMP_LE_OQ);
        }
        else {
            return _Simd_less_equal<arch::ISA::AVX2, 128, _DesiredType_>()(__left, __right);
        }
    }
};
...
template <class _DesiredType_>
struct _Simd_less_equal<arch::ISA::AVX512VLBW, 128, _DesiredType_> :
    _Simd_less_equal<arch::ISA::AVX512VLF, 128, _DesiredType_>
{
    template <class _IntrinType_>
    raze_nodiscard raze_static_operator raze_always_inline auto operator()(
        _IntrinType_ __left,
    ...
    {
        if constexpr (__is_epi8_v<_DesiredType_>)
            return _mm_cmple_epi8_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));

        else if constexpr (__is_epu8_v<_DesiredType_>)
            return _mm_cmple_epu8_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));

        else if constexpr (__is_epi16_v<_DesiredType_>)
            return _mm_cmple_epi16_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));

        else if constexpr (__is_epu16_v<_DesiredType_>)
            return _mm_cmple_epu16_mask(__intrin_bitcast<__m128i>(__left), __intrin_bitcast<__m128i>(__right));

        else
            return _Simd_less_equal<arch::ISA::AVX512VLF, 128, _DesiredType_>()(__left, __right);
    }
};
