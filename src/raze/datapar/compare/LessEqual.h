...
struct _Less_equal<arch::ISA::AVX2, 256, _DesiredType_> {
    ...
    raze_nodiscard raze_static_operator raze_always_inline auto operator()(
        ...
        _IntrinType_ __right) raze_const_operator noexcept
    {
        return _Not<arch::ISA::AVX2, 256>()(_Greater<arch::ISA::AVX2, 256, _DesiredType_>()(__left, __right));
    }
};
...
template <class _DesiredType_> struct _Less_equal<arch::ISA::AVX2, 128, _DesiredType_> : _Less_equal<arch::ISA::SSE42, 128, _DesiredType_> {};
